    ...
    <div className='container mx-auto px-4 my-6 relative'>
      ...
      { loading ? (
        loadingList.map((product,index)=>{
            return(
                <div className='w-full min-w-[310px]  md:min-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow' key={index+product} >
      ...
      (data.map((product,index)=>{
        return(
          <Link to={"product/"+product?._id} className='w-full min-w-[310px]  md:min-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow'key={index+product} >
